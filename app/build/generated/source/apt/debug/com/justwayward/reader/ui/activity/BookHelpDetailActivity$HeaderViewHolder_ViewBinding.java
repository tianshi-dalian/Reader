...
public class BookHelpDetailActivity$HeaderViewHolder_ViewBinding<T extends BookHelpDetailActivity.HeaderViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public BookHelpDetailActivity$HeaderViewHolder_ViewBinding(T target, View source) {
    this.target = target;
